...
export type MoveRequest =
  ...
  | { type: 'EQUIP_GEAR'; playerId: string; gearInstanceId: string; targetInstanceId: string; paymentRuneIds?: string[]; premiumRuneIds?: string[]; selectedRecycleCardInstanceIds?: string[] }
