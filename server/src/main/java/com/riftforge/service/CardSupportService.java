...
public class CardSupportService {
  ...
  private static final Map<String, String> PARTIAL_REASONS = Map.ofEntries(
      ...
      Map.entry("ECLIPSE", "Partial: alpha chain-window Reaction support exists for giving one public battlefield Unit/Champion -4 Might this turn. Predict from Eclipse remains deferred, and full official any-time Reaction timing remains incomplete."),
