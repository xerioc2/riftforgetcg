...
public class CardSupportService {
  ...
  private static final Map<String, String> PARTIAL_REASONS = Map.ofEntries(
      ...
      Map.entry("DIANA - SCORN OF THE MOON", "Partial: Diana's exact Legend ability can be activated by the focused showdown player: exhaust Diana to add 1 showdown-only Energy. That restricted Energy can be spent only while a showdown is active. Broader official Reaction/resource timing remains deferred."),
      ...
      Map.entry("LAST RITES", "Partial: alpha Equip lifecycle supports the exact printed Chaos rune plus recycle-2-from-Trash equip cost. Recycled cards move to the bottom of the owner's Main Deck pool, and full official Equip timing or additional card-specific effects remain deferred."),
      ...
      Map.entry("STAR-CROSSED", "Partial: alpha chain-window Reaction support exists for returning one friendly public battlefield Unit/Champion and one enemy public battlefield Unit/Champion to their owners' hands. Full official any-time Reaction timing remains incomplete."),
      Map.entry("ECLIPSE", "Partial: alpha chain-window Reaction support exists for giving one public battlefield Unit/Champion -4 Might this turn, then creating a private owner-only Predict choice. Full official any-time Reaction timing remains incomplete."),
      Map.entry("STUPEFY", "Partial: alpha chain-window Reaction support exists for giving one public battlefield Unit/Champion -1 Might this turn, to a minimum of 1, and drawing 1 privately. Full official any-time Reaction timing remains incomplete."),
      Map.entry("MOONFALL", "Partial: exact Action support chooses an active battlefield where you have a public Unit/Champion, may move one enemy public battlefield Unit/Champion there, then gives enemy units there -2 Might this turn. Full official timing and broader movement edge cases remain incomplete."),
