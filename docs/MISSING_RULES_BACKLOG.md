...
| Full battlefield abilities | Partial | Battlefields are selected, revealed, rendered, and hover-readable. Sunken Temple and Targon's Peak have exact active-lane alpha hooks for conquer-triggered payment/draw and end-turn rune readying, but Abandoned Hall, Aspirant's Climb, Hall of Legends, Fortified Position, player-selected choices, and full official location rules still need explicit handling before promotion. | battlefield model, effect handlers | Hall of Legends triggers on conquer and readies the legend after legal payment. |
