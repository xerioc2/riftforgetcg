...
| --- | --- | --- | --- | --- |
| Irelia, Blade Dancer | `irelia_wins_s3_shanghai_city_challenge.txt` | Pass | Blocked | `Defiant Dance`, `Flash`, `Charm`, `Zhonya's Hourglass`, `The Syren`. |
| Diana, Scorn of the Moon | `diana_wins_s3_suzhou_city_challenge.txt` | Pass | Blocked | `Hard Bargain`, `Abandon`, `Flash`, `The Syren`; Diana remains the recommended next target. |
| Annie, Dark Child | `annie_4th_at_lille_regional_qualifier.txt` | Needs review | Blocked | `Annie - Dark Child - Starter` (`OGS-017`) is missing from local card cache; blockers include `Hard Bargain` and `Flash`. |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Irelia, Blade Dancer | 8% | 54% | 1637 | Blocked | 2 list(s) extracted | Charm (UNSUPPORTED), Defiant Dance (UNSUPPORTED), Flash (UNSUPPORTED), Hard Bargain (UNSUPPORTED), Heart of Dark Ice (UNSUPPORTED) | Finish current/Irelia support slice |
| Diana, Scorn of the Moon | 7% | 54% | 1438 | Blocked | 3 list(s) extracted | Abandon (UNSUPPORTED), Flash (UNSUPPORTED), Hard Bargain (UNSUPPORTED), Invert Timelines (UNSUPPORTED), The Syren (UNSUPPORTED) | Reviewer-prioritized next interaction deck |
...
| Annie, Dark Child | n/a | n/a | n/a | Blocked | 1 list(s) extracted | Factory Recall (UNSUPPORTED), Flash (UNSUPPORTED), Hard Bargain (UNSUPPORTED), Switcheroo (UNSUPPORTED), Thermo Beam (UNSUPPORTED) | Aurora shell candidate with Miss Fortune |
