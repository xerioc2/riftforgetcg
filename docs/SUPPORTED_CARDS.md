...
| 2 | Irelia, Blade Dancer | 8% meta, 54% win, 1637 decks | Blocked | 2 Riftbound.gg guide lists extracted | Uploaded Shanghai list is down to `Zhonya's Hourglass` as the last Unsupported Gear blocker; The Syren, Charm, Defiant Dance, and Flash are Partial alpha support. |
