...
| Discipline | Irelia Tempo | Spell | Partial | Chain-backed Reaction boost/draw | Can be played only while focused during the current alpha chain window; creates a public chain item, gives a public battlefield Unit/Champion +2 Might this turn, and draws 1 privately on resolution. Full official "any time" Reaction timing remains incomplete. |
...
| Guardian Angel | Irelia Tempo | Gear | Partial | Gear/equipment | Alpha Equip lifecycle and printed Calm equip payment are covered: play to Base first, then equip from Base to a friendly public Unit/Champion in Base or at the battlefield; attached Gear cannot fight, returns to Base when its host leaves public play, and does not trigger Deathknell when returned. Full official Equip timing and replacement/reattachment edge cases remain incomplete. |
| Boots of Swiftness | Irelia Tempo | Gear | Partial | Gear/equipment | Alpha Equip lifecycle and printed Chaos equip payment are covered: play to Base first, then equip from Base to a friendly public Unit/Champion in Base or at the battlefield; attached Gear cannot fight, returns to Base when its host leaves public play, and does not trigger Deathknell when returned. Full official Equip timing and replacement/reattachment edge cases remain incomplete. |
