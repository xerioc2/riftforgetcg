...
| 3 | Diana, Scorn of the Moon | 7% meta, 54% win, 1438 decks | Blocked | 3 Riftbound.gg guide lists extracted | Uploaded Suzhou list blockers are now `Abandon`, `Hard Bargain`, and multiple interaction-heavy Partial effects; The Syren is Partial alpha support. This remains the recommended next support target. |
