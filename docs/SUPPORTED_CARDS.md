...
| Guardian Angel | Irelia Tempo | Gear | Partial | Gear/equipment | Basic Equip lifecycle is covered: play to Base first, then equip from Base to a friendly Unit/Champion in Base or at the battlefield; attached Gear cannot fight and returns to Base when its host leaves public play. Equip payment precision and card-specific edge cases remain incomplete. |
| Boots of Swiftness | Irelia Tempo | Gear | Partial | Gear/equipment | Basic Equip lifecycle is covered: play to Base first, then equip from Base to a friendly Unit/Champion in Base or at the battlefield; attached Gear cannot fight and returns to Base when its host leaves public play. Equip payment precision and card-specific edge cases remain incomplete. |
