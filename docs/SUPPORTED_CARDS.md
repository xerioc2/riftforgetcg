...
| Guardian Angel | Irelia Tempo | Gear | Partial | Gear/equipment | Alpha Equip lifecycle is covered: play to Base first, then equip from Base to a friendly Unit/Champion in Base or at the battlefield; attached Gear cannot fight, returns to Base when its host leaves public play, and does not trigger Deathknell when returned. Equip payment precision and card-specific edge cases remain incomplete. |
| Boots of Swiftness | Irelia Tempo | Gear | Partial | Gear/equipment | Alpha Equip lifecycle is covered: play to Base first, then equip from Base to a friendly Unit/Champion in Base or at the battlefield; attached Gear cannot fight, returns to Base when its host leaves public play, and does not trigger Deathknell when returned. Equip payment precision and card-specific edge cases remain incomplete. |
