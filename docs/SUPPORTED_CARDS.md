...
| Stacked Deck | Irelia Tempo | Spell | Partial | Spell: draw/card selection | Private top-3 prompt is implemented; selected card goes to hand and the rest recycle to bottom in deterministic alpha order. Keep Partial until official ordering/timing is confirmed. |
