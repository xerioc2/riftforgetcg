...
| Guardian Angel | Irelia Tempo | Gear | Partial | Gear/equipment | Basic Equip validation/attachment is covered: friendly Unit/Champion target in Base or at the battlefield only, cannot fight, and follows host death or return-to-hand cleanup. Card-specific text/payment edge cases remain incomplete. |
| Boots of Swiftness | Irelia Tempo | Gear | Partial | Gear/equipment | Basic Equip validation/attachment is covered: friendly Unit/Champion target in Base or at the battlefield only, cannot fight, and follows host death or return-to-hand cleanup. Card-specific text/payment edge cases remain incomplete. |
