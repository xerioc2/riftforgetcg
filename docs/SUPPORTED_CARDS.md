...
| Stellacorn Herder | Irelia Tempo | Unit | Supported | Movement draw trigger | Full printed text is implemented and directly tested in the single-battlefield alpha: moving between Base and battlefield draws 1, while same-zone reposition does not trigger. |
