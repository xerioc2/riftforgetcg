...
| Last Rites | Diana uploaded meta | Gear | 3 | CHAOS / premium 0 | `[Equip] — :rb_rune_chaos:, Recycle 2 cards from your trash (Pay the cost: Attach this to a unit you control.)` | Partial | Partial | Partial | Equipment lifecycle plus recycle Equip cost | Partial | Alpha lifecycle supports the exact printed Chaos rune plus recycle-2-from-Trash Equip cost. Recycled cards move to the bottom of the owner's Main Deck pool. Full official Equip timing and any additional card-specific effects remain deferred. |
